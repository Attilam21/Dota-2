-- ============================================
-- SCRIPT VERIFICA COMPLETA TABELLE SUPABASE
-- ============================================
-- Copia tutto questo script e incollalo nel SQL Editor di Supabase
-- Mostra tutte le tabelle, colonne, trigger, funzioni, RLS e indici
-- ============================================
...
-- FINE VERIFICA
-- ============================================
-- Se vedi tutti i risultati, significa che tutto è stato creato correttamente!
-- ============================================
